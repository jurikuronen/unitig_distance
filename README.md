...
```
/bin/unitig_distance -E <path_to_edges_file> -Q <path_to_queries_file> -n 100 -o <output_stem> -t 4 -v | tee <output_stem>.ud_log
```
...
```
/bin/unitig_distance -E <path_to_edges_file> -U <path_to_unitigs_file> -k 61 -Q <path_to_queries_file> -1q -o <output_stem> -t 16 -v | tee <output_stem>.ud_log
```
...
```
/bin/unitig_distance -E <path_to_edges_file> -U <path_to_unitigs_file> -k 61 -Q <path_to_queries_file> -1q -S <path_to_sggs_file> -r -o <output_stem> -t 16 -v | tee <output_stem>.ud_log
```
